...
export UBUNTU_PACKAGES="vim python3-pip g++ clang-format gnome-tweak-tool chromium-browser ant gnome-shell-extension-system-monitor cmake ubuntu-restricted-addons ubuntu-restricted-addons git exuberant-ctags vlc libboost-all-dev cabextract font-manager powertop atop tmux wavemon gnuplot-x11 meld tmux clang-format ssh-askpass-gnome"
