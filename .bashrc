...
alias aptupd='sudo apt update && sudo apt dist-upgrade -y && sudo apt full-upgrade -y && sudo apt upgrade -y && sudo apt autoremove -y && sudo snap refresh && sudo aptitude safe-upgrade'
